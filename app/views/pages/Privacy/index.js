              ...
              <Card className="bg-secondary border-0">
                <CardBody className="px-lg-5 py-lg-5">
                  <div className={clsx("documentTitle", "mt-3")}>
                    Privacy Policy of Areen Order Hub Hiring Solutions Pvt. Ltd.
                  </div>
                  <div className={clsx("bodyText")}>
                    Areen Order Hub Hiring Solutions Pvt. Ltd. operates{" "}
                    {baseUrl}, which provides the Project Management Service
                    ('Service')
                  </div>
                  ...
                  <div className={clsx("sectionTitle", "mt-3")}> Log Data</div>
                  <div className={clsx("bodyText", "mt-3")}>
                  ...
                  <div className={clsx("sectionTitle", "mt-3")}>Cookies</div>
                  <div className={clsx("bodyText", "mt-3")}>
                  ...
                  <div className={clsx("sectionTitle", "mt-3")}>Security</div>
                  <div className={clsx("bodyText", "mt-3")}>
